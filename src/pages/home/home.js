...
const Home = () => {
  ...
  useEffect(() => {
    ...
    setData((prevData) => ({
      ...
      dataLine: [
        { time: new Date().toLocaleTimeString(), ...fetchDataFromIoT() },
      ],
    }));
    ...
    <div className="container">
      <div className="row">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex gap-4">
                <span
                  className="btn"
                  style={{ backgroundColor: COLORS.turbidity }}
                >
                  Turbidez
                </span>
                <span
                  className="btn py-1 rounded-full text-sm"
                ...
                <span
                  className="btn py-1 rounded-full text-sm"
                  style={{ backgroundColor: COLORS.pH }}
                >
                  pH
                </span>
              </div>
        ...
        <div className="col-md-6">
          <div
            className="rounded-lg shadow-lg p-6"
            style={{ backgroundColor: COLORS.cardBg, height: "456.6px" }}
          >
            <h2 className="text-xl font-semibold mb-4">
      ...
      <div className="row">
        <div className="col-md-12">
          <div
            className="mt-6 rounded-lg shadow-lg p-6"
            style={{ backgroundColor: COLORS.cardBg }}
          >
            <h2 className="text-xl font-semibold mb-4">
            ...
            <p className="text-gray-300 mb-4">
              Tendencia de concentración de metales pesados en los próximos
              meses
            </p>
      ...
      <div className="row">
        {data.dataLine.length > 0 && (
          ...
          <div
              className="card rounded-lg shadow-lg p-4 text-center"
              style={{ backgroundColor: COLORS.cardBg, padding: "10px 0 10px"}}
            >
              <h3 className="text-lg font-medium mb-2">Turbidez</h3>
              <p
                className="text-3xl font-bold"
                style={{ color: COLORS.turbidity }}
              >
